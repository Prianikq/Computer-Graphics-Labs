...
public abstract class CGLab01 : GFXApplicationTemplate<CGLab01>
{
    ...
    protected override void OnDeviceUpdate(object s, GDIDeviceUpdateArgs e)
    {
        ...
        Console.WriteLine("FIRST:" + FirstPoint.X + " " + FirstPoint.Y);
        Console.WriteLine("SECOND: " +SecondPoint.X + " " + SecondPoint.Y);
        e.Surface.DrawLine( Color.LawnGreen.ToArgb(),  new DVector2(100, 100),  new DVector2(150, 80)); // Y - вниз, X - вправо
    }
